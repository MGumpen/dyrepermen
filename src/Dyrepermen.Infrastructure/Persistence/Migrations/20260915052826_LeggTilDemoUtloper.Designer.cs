...
namespace Dyrepermen.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915052826_LeggTilDemoUtloper")]
    partial class LeggTilDemoUtloper
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dyrepermen.Domain.Entities.Behandling", b =>
                {
                    ...
                    b.ToTable("behandling", null, t =>
                        {
                            t.HasCheckConstraint("ck_behandling_type", "type IN ('V','O','F','K','T','A')");
                        });
                });
            ...
            modelBuilder.Entity("Dyrepermen.Domain.Entities.Bruker", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("DemoUtloper")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("demo_utloper");
                    ...
                    b.HasIndex("DemoUtloper")
                        .HasDatabaseName("ix_asp_net_users_demo_utloper");
            ...
            modelBuilder.Entity("Dyrepermen.Domain.Entities.Vetbesok", b =>
                {
                    ...
                    b.Property<DateOnly?>("NesteKontrollDato")
                        .HasColumnType("date")
                        .HasColumnName("neste_kontroll_dato");
                    ...
                    b.Property<int?>("RefundertKr")
                        .HasColumnType("integer")
                        .HasColumnName("refundert_kr");

                    b.Property<int?>("VeterinarId")
                        .HasColumnType("integer")
                        .HasColumnName("veterinar_id");

                    b.HasKey("Id")
                        .HasName("pk_vetbesok");

                    b.HasIndex("VeterinarId")
                        .HasDatabaseName("ix_vetbesok_veterinar_id");

                    b.HasIndex("DyrId", "Dato")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_vetbesok_dyr_dato");

                    b.ToTable("vetbesok", null, t =>
                        {
                            t.HasCheckConstraint("ck_vetbesok_kostnad", "kostnad_kr IS NULL OR kostnad_kr >= 0");

                            t.HasCheckConstraint("ck_vetbesok_refundert", "refundert_kr IS NULL OR refundert_kr >= 0");

                            t.HasCheckConstraint("ck_vetbesok_refusjon_krever_krav", "refundert_kr IS NULL OR forsikring_krevd");
                        });
                });
            ...
            modelBuilder.Entity("Dyrepermen.Domain.Entities.Veterinar", b =>
                {
                    ...
                    b.Property<string>("ApentFredag")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("apent_fredag");

                    b.Property<string>("ApentLordag")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("apent_lordag");

                    b.Property<string>("ApentMandag")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("apent_mandag");

                    b.Property<string>("ApentOnsdag")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("apent_onsdag");

                    b.Property<string>("ApentSondag")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("apent_sondag");

                    b.Property<string>("ApentTirsdag")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("apent_tirsdag");

                    b.Property<string>("ApentTorsdag")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("apent_torsdag");
                    ...
                    b.Property<string>("Nettside")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("nettside");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_veterinar");

                    b.HasIndex("HusstandId", "Navn")
                        .HasDatabaseName("ix_veterinar_husstand_navn");

                    b.ToTable("veterinar", null, t =>
                        {
                            t.HasCheckConstraint("ck_veterinar_telefon", "telefon IS NULL OR length(btrim(telefon)) BETWEEN 3 AND 20");
            ...
            modelBuilder.Entity("Dyrepermen.Domain.Entities.Vetbesok", b =>
                {
                    ...
                    b.HasOne("Dyrepermen.Domain.Entities.Veterinar", "Veterinar")
                        .WithMany("Besok")
                        .HasForeignKey("VeterinarId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_vetbesok_veterinar_veterinar_id");
            ...
            modelBuilder.Entity("Dyrepermen.Domain.Entities.Veterinar", b =>
                {
                    b.HasOne("Dyrepermen.Domain.Entities.Husstand", "Husstand")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_veterinar_husstand_husstand_id");
